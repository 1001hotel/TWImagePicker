...
s.name         = "TWImagePicker"
  ...
  s.source_files  = "TWImagePicker/TWImagePicker/TWImagePicker/*.{h,m}"
  s.resources = "TWImagePicker/TWImagePicker/TWImagePicker/Images/*.png", "TWImagePicker/TWImagePicker/TWImagePicker/*.xib"
